...
?> 
    <h5 class="card-category">Status <input type="text" style="text-align:center; width:30%; color:red; border-color:red;" value="Berbahaya" class="form-control" readonly></h5>   
<?php   
    }
?> 
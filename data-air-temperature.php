...
<?php
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      <canvas id="chartTemperature" style="display: block; height: 190px;"></canvas>
      <script>
         var canvas = document.getElementById('chartTemperature').getContext("2d");
        ...
        gradientFill.addColorStop(1, hexToRGB('#1472e6', 0.4));
        var data = {
            ...
            datasets: [
            {
                ...
                borderWidth: 2,
                data: [<?php while ($b = mysqli_fetch_array($y_temperature)) { echo  $b['temperature'] . ',';}?>],
            }
            ]
        };
        var option = 
